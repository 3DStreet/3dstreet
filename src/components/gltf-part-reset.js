...
AFRAME.registerComponent('gltf-part-reset', {
  schema: {
    buffer: {default: true},
    part: {type: 'string'},
    src: {type: 'asset'}
  ...
  update: function () {
    ...
    this.getModel(function (modelPart) {
      ...
      console.log(modelPart.parent);
      // material = modelPart.parent.getObjectByProperty('type', 'Material').clone(true);
      // part = model.getObjectByName(this.data.part);
      // el.setObject3D('material', material)
