...
(function () {
  function buildAssetHTML (assetUrl) {
    ...
    return `
          ...
          <a-mixin id="box-truck" gltf-part-plus="src: #vehicles; part: box-truck" glassreflection></a-mixin>
          <a-mixin id="city-bus" gltf-part-plus="src: #vehicles; part: city-bus" glassreflection></a-mixin>
          <a-mixin id="food-trailer" gltf-part-plus="src: #vehicles; part: food-trailer" glassreflection></a-mixin>
          <a-mixin id="sedan" gltf-part-plus="src: #vehicles; part: sedan" glassreflection></a-mixin>
          <a-mixin id="sedan-taxi" gltf-part-plus="src: #vehicles; part: sedan-taxi" glassreflection></a-mixin>
