...
(function () {
  function buildAssetHTML (assetUrl) {
    ...
    return `
          ...
          <img id="seamless-bright-road" src="${assetUrl}assets/materials/asphalthd_Base_Color.jpg" crossorigin="anonymous">
          ...
          <a-mixin id="word-only" atlas-uvs="totalRows: 8; totalColumns: 8; column: 2; row: 3" scale="2.75 2.75 2.75"></a-mixin>
          ...
          <a-mixin id="word-loading" atlas-uvs="totalRows: 8; totalColumns: 4; column: 4; row: 1" scale="3 2 3"></a-mixin>
