...
require('./aframe-components/focus-hotspot.js');
...
require('./aframe-components/osm-buildings.js');
require('./aframe-components/osm-streets.js');
...
require('./aframe-components/play/fly-mode.js');
