...
describe('A-Frame Streetmix', function () {
  ...
  describe('#createBuildingsArray()', function () {
    ...
    // test createBuildingArray(maxLength = 10) returns [{ mixin: "SM3D_Bld_Mixed_Corner_4fl", position: "0 0 0", tag: "a-entity" }, {mixin: "SM3D_Bld_Mixed_Double_5fl", position: "0 0 5", tag: "a-entity"} ]
