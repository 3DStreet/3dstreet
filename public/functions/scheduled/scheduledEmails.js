...
const sendGenerationOutcomeEmail = async (db, uid, jobRef, options = {}) => {
  ...
  try {
    ...
    // Generation outcome emails stay English-only (not lifecycle emails; see
    // #1841 scope) and do their own "Hi there" fallback since getUserInfo
    // returns a null displayName when Auth has none.
